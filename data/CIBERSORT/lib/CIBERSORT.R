...
#   In R:
#       source('CIBERSORT.R')
# source('c:/Work/src/Dream/Deconvolution/data.3/CIBERSORT.R')
#       results <- CIBERSORT('sig_matrix_file.txt','mixture_file.txt', perm, QN, absolute, abs_method)
# result<-CIBERSORT('c:/Work/src/Dream/Deconvolution/data.2/GSE11103_matrix_classes.GSE11103_matrix_pure.bm.K999.0.txt', 'c:/Work/src/Dream/Deconvolution/data.2/GSE11103_matrix_mixtures.txt')
# result<-CIBERSORT('c:/Work/src/Dream/Deconvolution/data.4/pure.tsv', 'c:/Work/src/Dream/Deconvolution/data.4/mix.txt')
# result<-CIBERSORT('c:/Work/src/Dream/CIBERSORT/LM22_v3.txt', 'c:/Work/src/Dream/CIBERSORT/mix_v3.txt')
# result<-CIBERSORT('c:/Work/src/Dream/DeconvolutionReview/input/RatBrain_GSE19380/sig.txt', 'c:/Work/src/Dream/DeconvolutionReview/input/RatBrain_GSE19380/mix.txt')
# result<-CIBERSORT('c:/Work/src/Dream/DeconvolutionReview/input/BreastBlood_GSE29832/sig.csv', 'c:/Work/src/Dream/DeconvolutionReview/input/BreastBlood_GSE29832/mix.csv')
# result<-CIBERSORT('c:/Work/src/Dream/DeconvolutionReview/input/PERT_Cultured_GSE16589/sig.txt', 'c:/Work/src/Dream/DeconvolutionReview/input/PERT_Cultured_GSE16589/mix.txt')
# result<-CIBERSORT('c:/Work/src/Dream/Yada/data/DeconRNASeq/anaysis/pure.txt', 'c:/Work/src/Dream/Yada/data/DeconRNASeq/analysis/mix.txt')
# result<-CIBERSORT('c:/Work/src/Dream/Yada/data/EPIC/analysis/TRefProfiles.txt', 'c:/Work/src/Dream/Yada/data/EPIC/analysis/mix.txt')
# result<-CIBERSORT('c:/Work/src/Dream/Yada/data/BreastBlood_GSE29832/pure.txt', 'c:/Work/src/Dream/Yada/data/BreastBlood_GSE29832/mix.txt')
# result<-CIBERSORT('c:/Work/src/Dream/Yada/data/RatBrain_GSE19380/pure.txt', 'c:/Work/src/Dream/Yada/data/RatBrain_GSE19380/mix.txt')
#       Options:
